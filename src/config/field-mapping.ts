...
export const WEEK_DATE_MAP: Record<string, { start: string; end: string }> = {
  ...
  'W31': { start: '2026-07-27', end: '2026-07-31' },
  'W32': { start: '2026-08-03', end: '2026-08-07' },
  'W33': { start: '2026-08-10', end: '2026-08-14' },
  'W34': { start: '2026-08-17', end: '2026-08-21' },
  'W35': { start: '2026-08-24', end: '2026-08-28' },
  'W36': { start: '2026-08-31', end: '2026-09-04' },
  'W37': { start: '2026-09-07', end: '2026-09-11' },
};
